        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    break;
                case 2:
                    String input = ValidationAndNormalizingTextUtil.getStringByRegex("Please enter a name you want to search: ", "Please enter character only", "[a-zA-Z]");
                    controller.search(input);
                    break;
                case 3:
                    System.out.print("Please enter a Student ID that you want to manipulate: ");
                    String id = ValidationAndNormalizingTextUtil.getStringByRegex("Enter Student ID: ", "Please enter valid character", "[a-zA-Z0-9]+");
                    String uOrD = ValidationAndNormalizingTextUtil.pressUDtoContinue("Do you want to update or delete(U/D): ");
